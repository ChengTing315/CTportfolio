...
import Amplify from '../public/assets/skills/amplify.png';
import NodeJS from '../public/assets/skills/nodejs.png';
import Rest from '../public/assets/skills/rest.png';
import GraqhQL from '../public/assets/skills/graphql.png';
...
import SVN from '../public/assets/skills/SVN.png';
import API from '../public/assets/skills/api.png';
import ReactNaive from '../public/assets/skills/reactnative.png';
      ...
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={ReactNaive} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>React Naive</h3>
              </div>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={Amplify} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>Amplify</h3>
              </div>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={GraqhQL} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>GraphQL</h3>
              </div>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div className='p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-300'>
            <div className='grid grid-cols-2 gap-4 justify-center items-center'>
              <div className='m-auto'>
                <Image src={SVN} width='64px' height='64px' alt='/' />
              </div>
              <div className='flex flex-col items-center justify-center'>
                <h3>SVN</h3>
              </div>
