    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <a
            href='https://github.com/ChengTing315/Targetapp'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://targetapp-two.vercel.app/'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <h2>Matching Game</h2>
          <p>
          A Simple Matching game with cities and capitals.
          </p>
          <a
            href='https://github.com/ChengTing315/MatchingCC'
            target='_blank'
            rel='noreferrer'
          >
            <button className='px-8 py-2 mt-4 mr-8'>Code</button>
